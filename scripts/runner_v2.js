...
const CONFIG = {
  ...
  OUTPUT_DIR: path.join(BASE_DIR, "outputs/v2"),
  LOG_DIR: path.join(BASE_DIR, "logs/v2"),

  PROMPT_PATHS: {
    FEATURE_STRATEGY: path.join(
      BASE_DIR,
      "prompts/v2/feature_strategy.prompt.txt",
    ),
    PART_STRATEGY: path.join(
      BASE_DIR,
      "prompts/v2/part_level_strategy2.prompt.txt",
    ),
  },
