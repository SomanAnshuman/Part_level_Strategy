...
const CONFIG = {
  ...
  OUTPUT_DIR: path.join(BASE_DIR, "outputs/v4"),
  LOG_DIR: path.join(BASE_DIR, "logs/v4"),

  PROMPT_PATHS: {
    PART_STRATEGY: path.join(
      BASE_DIR,
      "prompts/v4/part_level_strategy2.prompt.txt",
    ),
  },
...
async function run() {
  ...
  const featureStrategies = readJson(CONFIG.STRATEGY_LIST_PATH);
