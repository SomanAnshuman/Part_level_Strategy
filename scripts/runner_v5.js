...
const CONFIG = {
  ...
  OUTPUT_DIR: path.join(BASE_DIR, "outputs/v5"),
  LOG_DIR: path.join(BASE_DIR, "logs/v5"),

  PROMPT_PATHS: {
    PART_STRATEGY: path.join(
      BASE_DIR,
      "prompts/v5/part_level_strategy.prompt.txt",
    ),
    FEATURE_REFINEMENT: path.join(
      BASE_DIR,
      "prompts/v5/feature_strategy_refinement.prompt.txt",
    ),
  },
